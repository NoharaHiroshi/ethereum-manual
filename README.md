...
- [目录](#ethereum-manual)
  * [一、基础知识相关](#--------)
    + [1、以太坊发展有哪几个阶段，目前正处于什么阶段？](#1-----------------------)
    + [2、以太坊区块奖励变化](#2----------)
    + [3、EIP是什么？ERC又是什么？有什么联系](#3-eip----erc----------)
    + [4、ENS是什么？](#4-ens----)
    + [5、The Dao事件是什么？](#5-the-dao------)
    + [6、ETH与ETC有什么区别与联系？](#6-eth-etc---------)
    + [7、软分叉与硬分叉？](#7---------)
    + [8、以太坊钱包是什么？](#8----------)
    + [9、非确定性钱包与确定性钱包有什么区别？](#9-------------------)
    + [10、非确定性钱包的构成？](#10-----------)
    + [11、助记词是什么？](#11--------)
    + [12、种子秘钥是什么？](#12---------)
    + [13、HD钱包是什么？](#13-hd------)
    + [14、什么是扩展秘钥？](#14---------)
    + [15、什么是增强秘钥？](#15---------)
    + [16、什么是HD钱包秘钥路径？](#16----hd-------)
    + [17、HD钱包的树状结构导航？](#17-hd----------)
    + [18、冷钱包与热钱包？](#18---------)
    + [19、nonce是什么？在交易中起到什么作用？](#19-nonce---------------)
    + [20、交易中有哪些参数？](#20----------)
    + [21、交易签名中的R、S、V分别是什么？怎么得来的？](#21-------r-s-v------------)
    + [22、交易原始数据是否包含发送方字段？如果不包含，如何知道交易的发送方？](#22----------------------------------)
    + [23、如何签名交易](#23-------)
    + [24、如何检验签名](#24-------)
  * [二、ERC协议相关](#--erc----)
    + [1、ERC20是什么？](#1-erc20----)
    + [2、ERC233是什么？](#2-erc233----)
    + [3、ERC721是什么？](#3-erc721----)
    + [4、ERC777是什么？](#4-erc777----)
    + [5、ERC1400是什么？](#5-erc1400----)
    + [6、ERC1820是什么？](#6-erc1820----)
    + [7、ERC1404是什么？](#7-erc1404----)
    + [8、ERC621是什么？](#8-erc621----)
    + [9、ERC应用协议的兼容性？](#9-erc---------)
  * [三、合约设计相关](#--------)
    + [1、如何判断address是个人地址还是合约地址？](#1-----address------------)
    + [2、如何同时维护授权/撤销操作员记录，避免数据不一致？](#2--------------------------)
  * [四、以太坊漏洞相关](#---------)
    + [1、整数溢出漏洞](#1-------)
    + [2、The Dao漏洞](#2-the-dao--)
    + [3、重放漏洞](#3-----)
    + [4、call注入漏洞](#4-call----)
